    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PublishTagsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PublishesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PublishLikesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserLikesId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLikes", x => new { x.PublishLikesId, x.UserLikesId });
                    table.ForeignKey(
                        name: "FK_UserLikes_AspNetUsers_UserLikesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Publish_PublishTag_PublishesId",
